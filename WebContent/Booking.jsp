...
<script>[]
function myFunction() {
  alert("Final Confirmation for Booking");
}
</script>
</head>
<body>
	<h1 align="center" class="display-3">Hotel Details</h1>
	<!--  form method="post" action="CustomerServlet" class="form-horizontal"-->
	  <form action="ExternalServlet"
		method="post">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Room Type:&nbsp;&nbsp;${hroo.type}</p>
			...
			<input type="hidden" name="paymentAmount" id="paymentAmount"
							value="${hroo.price}" > <input type="hidden" name="retUrl"
							id="retUrl" value="http://localhost:8092/HotelManagement/Payment.jsp">
			<p class="lead">
