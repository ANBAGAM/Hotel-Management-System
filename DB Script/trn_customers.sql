...
SET DEFINE OFF;
Insert into HR.TRN_CUSTOMERS (ACCOUNT_NUMBER,CUSTOMER_NAME,CUSTOMER_ID,EMAIL,PHONE_NUMBER,FATHERS_NAME,GENDER,BALANCE,USERNAME,PASSWORD,DOB,PERMANENT_ADDRESS,PERMANENT_CITY,CURRENT_ADDRESS,CURRENT_CITY,STATE,IFSC_CODE,FLAG,CREATED_DATE,MODIFIED_DATE) values (620410100000,'Athiselvam',5003,'athitek@rediffmail.com',9042401691,'Nainar','Male',38007,'its773','pass123',to_date('11-05-97','DD-MM-RR'),'shanmugam street','shencottai','shanmugam street','shencottai','Tamil nadu','ATEK000138',1,to_timestamp('22-05-19 09:43:46.746000000 AM','DD-MM-RR HH12:MI:SSXFF AM'),to_timestamp('22-05-19 09:43:46.746000000 AM','DD-MM-RR HH12:MI:SSXFF AM'));
Insert into HR.TRN_CUSTOMERS (ACCOUNT_NUMBER,CUSTOMER_NAME,CUSTOMER_ID,EMAIL,PHONE_NUMBER,FATHERS_NAME,GENDER,BALANCE,USERNAME,PASSWORD,DOB,PERMANENT_ADDRESS,PERMANENT_CITY,CURRENT_ADDRESS,CURRENT_CITY,STATE,IFSC_CODE,FLAG,CREATED_DATE,MODIFIED_DATE) values (620410100004,'Anbagam',5004,'anbu@rediffmail.com',9597221466,'Nidhanam','Male',31993,'its985','n123',to_date('14-12-97','DD-MM-RR'),'VOC street','Tenkasi','VOC street','Tenkasi','Tamil nadu','ATEK000134',1,to_timestamp('22-05-19 09:43:51.799000000 AM','DD-MM-RR HH12:MI:SSXFF AM'),to_timestamp('22-05-19 09:43:51.799000000 AM','DD-MM-RR HH12:MI:SSXFF AM'));
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HR"."SYS_C004313" ON "HR"."TRN_CUSTOMERS" ("CUSTOMER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HR"."SYS_C004314" ON "HR"."TRN_CUSTOMERS" ("EMAIL") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HR"."SYS_C004315" ON "HR"."TRN_CUSTOMERS" ("PHONE_NUMBER") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index SYS_C004316
--------------------------------------------------------

  CREATE UNIQUE INDEX "HR"."SYS_C004316" ON "HR"."TRN_CUSTOMERS" ("USERNAME") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT)
  TABLESPACE "USERS" ;
